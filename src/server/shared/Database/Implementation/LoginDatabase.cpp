...
void LoginDatabaseConnection::DoPrepareStatements()
{
    ...
    PREPARE_STATEMENT(LOGIN_SET_EXPIREDACCVIP, "UPDATE account_vip SET active = 0 WHERE active = 1 AND unsetdate<>setdate AND unsetdate<=UNIX_TIMESTAMP()", CONNECTION_ASYNC)
