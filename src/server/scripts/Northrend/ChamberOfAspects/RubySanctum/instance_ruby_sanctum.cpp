...
public:
    ...
    struct instance_ruby_sanctum_InstanceMapScript : public InstanceScript
    {
		...
		uint64 m_uiZarithrianStalkerGUID1;
		uint64 m_uiZarithrianStalkerGUID2;
		...
		// trash commander GUID
		uint64 m_uiCharscaleCommanderGUID1;
		uint64 m_uiCharscaleCommanderGUID2;
        ...
        void Initialize()
        {
			...
			m_uiCharscaleCommanderGUID1 = 93629;
			m_uiCharscaleCommanderGUID1 = 93630;
			m_uiZarithrianStalkerGUID1 = 397941;
			m_uiZarithrianStalkerGUID2 = 397942;
        }
...
>>>>>>> 92ad375864772638ca50ea00b3c89ca36e0d9c3c
        ...
        uint64 GetData64(uint32 uiData)
        {
            switch(uiData)
            {
				...
				case NPC_CHARSCALE_COMMANDER_1:   return m_uiCharscaleCommanderGUID1;
				case NPC_CHARSCALE_COMMANDER_2:   return m_uiCharscaleCommanderGUID2;
				case NPC_ZARITHRIAN_STALKER_1:    return m_uiZarithrianStalkerGUID1;
				case NPC_ZARITHRIAN_STALKER_2:    return m_uiZarithrianStalkerGUID2;
            }
            return 0;
        }
