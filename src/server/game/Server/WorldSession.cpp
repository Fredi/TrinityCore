...
WorldSession::WorldSession(uint32 id, WorldSocket *sock, AccountTypes sec, bool isvip, uint8 expansion, time_t mute_time, LocaleConstant locale, uint32 recruiter):
