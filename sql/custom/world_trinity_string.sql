DELETE FROM `trinity_string` WHERE entry IN (11002, 11003, 11004, 11005);
...
(11005, '|cFFFFFC00[WARDEN]|cFF00FFFF[|cFF60FF00%s|cFF00FFFF] Possible cheater! (Kicked)|r', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
