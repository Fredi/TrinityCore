...
('-1666110','In rotating spheres pulsating with dark energy!','Во вращающихся сферах пульсирует темная энергия!','0','3','0','0',''),
('-1666111','Your allies pushed Haliona further into the physical world!','Ваши союзники протолкнули Халиона дальше в физический мир!','0','3','0','0',''),
('-1666112','Your allies pushed Haliona further into the real world!','Ваши союзники протолкнули Халиона дальше в реальный мир!','0','3','0','0',''),
('-1666113','Being alone in one of the worlds, Halion restores vitality.','Находясь в покое в одном из миров, Халион восстанавливает жизненные силы.','0','3','0','0',''),
...
('-1666405','|3-3(%s) falls into a trance!','|3-3(%s) впадает в исступление!','0','3','0','0','');
